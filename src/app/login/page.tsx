        ...
        <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-900 via-slate-900 to-black p-4">
            <div className="w-full max-w-md p-8 rounded-2xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl">
                <div className="text-center mb-10">
                    ...
                    <p className="text-slate-400">Sign in to manage your goals</p>
                </div>
                ...
                {message && (
                    <div className="mb-6 p-4 rounded-xl bg-indigo-500/20 border border-indigo-500/50 text-indigo-200 text-sm text-center">
                        {message}
                    </div>
                )}
                ...
                <form className="space-y-6">
                    ...
                    <div className="flex flex-col gap-4 pt-4">
                        <button
                            formAction={login}
                            className="w-full py-3 px-4 bg-indigo-600 hover:bg-indigo-500 text-white font-semibold rounded-xl transition-all active:scale-95 shadow-lg shadow-indigo-500/25"
                        >
                            Log in
                        </button>
                        <button
                            formAction={signup}
                            className="w-full py-3 px-4 bg-white/5 hover:bg-white/10 text-white font-semibold rounded-xl border border-white/10 transition-all active:scale-95"
                        >
                            Sign up
                        </button>
                    </div>
                    ...
                    <button
                        ...
                        formNoValidate
                        className="w-full py-3 px-4 bg-white text-slate-900 hover:bg-slate-100 font-semibold rounded-xl transition-all active:scale-95 flex items-center justify-center gap-2"
                    >
